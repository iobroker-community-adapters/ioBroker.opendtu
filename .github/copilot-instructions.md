...
### Test Coverage Areas (OpenDTU Specific)
...
## Code Structure (OpenDTU Specific)
...
### WebSocket Handling (OpenDTU Specific)
...
### HTTP API Best Practices (OpenDTU Specific)
...
### OpenDTU-Specific Error Handling
```javascript
try {
