...
const stateDefinition = {
    ...
    // DC
    'dc_name': {
        id: 'dc.channel_%count%.name',
        name: 'Name of the channel as configured in web GUI',
        role: 'state',
        write: false,
        read: true,
        type: 'string',
    ...
    'dc_yieldtotal': {
        id: 'dc.channel_%count%.yieldtotal',
    ...
    'dc_irradiation': {
        id: 'dc.channel_%count%.irradiation',
