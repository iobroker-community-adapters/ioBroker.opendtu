...
const stateDefinition = {
    ...
    'name': {
        id: 'name',
        name: 'Name of the inverter as configured in WebGUI',
        role: 'info.name',
        write: false,
        read: true,
        type: 'string',
    ...
    'hwpartnumber': {
        id: 'hwpartnumber',
        name: 'Hardware part number of the inverter',
        role: 'state',
        write: false,
        read: true,
        type: 'number',
    ...
    'restart': {
        ...
        name: 'Restart the inverter (also resets YieldDay)',
        role: 'button',
        write: true,
        read: true,
        type: 'boolean',
    ...
    'dc_name': {
        ...
        name: 'Name of the input as configured in WebGUI',
        role: 'info.name',
        write: false,
        read: true,
        type: 'string',
    ...
    'dc_power': {
        ...
        name: 'DC power of specific input',
        role: 'value.power',
        write: false,
        read: true,
        type: 'number',
    ...
    'dc_voltage': {
        ...
        name: 'DC voltage of specific input',
        role: 'value.voltage',
        write: false,
        read: true,
        type: 'number',
    ...
    'dc_current': {
        ...
        name: 'DC current of specific input',
        role: 'value.current',
        write: false,
        read: true,
        type: 'number',
    ...
    'dc_irradiation': {
        ...
        name: 'Ratio DC power over set maximum power (in WebGUI)',
        role: 'state',
        write: false,
        read: true,
        type: 'number',
    ...
    'inv_yieldtotal': {
        id: 'yieldtotal',
        name: 'Energy converted to AC since reset',
        role: 'value.power.production',
        write: false,
        read: true,
        type: 'number',
    ...
    'dtu_hostname': {
        id: 'hostname',
        name: 'Current hostname of the DTU (as set in WebGUI)',
        role: 'info.name ',
        write: false,
        read: true,
        type: 'string',
