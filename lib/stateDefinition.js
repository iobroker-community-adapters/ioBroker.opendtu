...
const stateDefinition = {
    ...
    // INV
    'inv_yieldtotal': {
        id: 'inv.inverter_%count%.yieldtotal',
        name: 'Total energy converted to AC since reset on specific inverter',
        role: 'value.power.production',
        write: false,
        read: true,
        type: 'number',
    ...
    'inv_efficiency': {
        id: 'inv.inverter_%count%.efficiency',
        name: 'Ratio AC Power over DC Power in percent',
        role: 'state',
        write: false,
        read: true,
    ...
    'inv_temperature': {
        id: 'inv.inverter_%count%.temperature',
        name: 'Temperature of inverter in degree celsius',
        role: 'value.temperature',
        write: false,
        read: true,
    ...
    'inv_power dc': {
        id: 'inv.inverter_%count%.power',
        name: 'Total power of specific inverter in watt',
        role: 'value.power',
        write: false,
        read: true,
        type: 'number',
    ...
    'inv_yieldday': {
        id: 'inv.inverter_%count%.yieldday',
