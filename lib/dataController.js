class DataController {
                ...
                switch (stateName) {
                    ...
                    default:
                        ...
                        if (stateName.toLowerCase() == 'reachable') {
                            if (val == true) {
                                const serialIdx = this.inverterOffline.indexOf(inverter.serial);
                                this.inverterOffline.splice(serialIdx, 1);
                            }
                            else {
    ...
    async createPowerControls(serial) {
        ...
        if (!this.createCache.includes(powerControlChannelId)) {
            const deviceObj = {
                type: 'channel',
                common: {
                    name: 'Power control',
            ...
            this.createCache.push(powerControlChannelId);
        }
